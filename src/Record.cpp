...
Record::Record(const double averageCoherence, const QDateTime& startTime, const int duration, const double achievementScore, const std::vector<double> percentCoh): percentCoh{percentCoh}
{
